...
public class MainApp extends Application {
    ...
    /**
     * Returns a {@code ModelManager} with the data from {@code storage}'s zerotoone book and {@code userPrefs}. <br>
     * The data from the sample zerotoone book will be used instead if {@code storage}'s zerotoone book is not found,
     * or an empty zerotoone book will be used instead if errors occur when reading {@code storage}'s zerotoone book.
     */
